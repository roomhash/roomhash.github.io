...
const catalog = {
  ...
  'appstore.open': ['Open Roomlets', '打开聊应用'],
  'appstore.title': ['Roomlet', '聊应用'],
  'appstore.close': ['Close Roomlets', '关闭聊应用'],
  'appstore.help': ['Roomlets only show data synchronized from connected peers; completeness and consistency are not guaranteed.', '聊应用仅展示关联节点同步过来的数据，并不保证显示数据的完整性和一致性。'],
  'appstore.loading': ['Loading Roomlets...', '正在加载聊应用…'],
  'appstore.empty': ['No Roomlets are available.', '暂无可用的聊应用。'],
  'appstore.unavailable': ['Roomlets are unavailable: {message}', '聊应用暂不可用：{message}'],
  'appstore.send': ['Send', '发送'],
  'appstore.sending': ['Sending...', '发送中…'],
  'appstore.wasm': ['Roomlet', '聊应用'],
  'appstore.web': ['Web app', '网页应用'],
  'appstore.sent': ['Roomlet shared with this channel', '聊应用已分享到当前频道'],
