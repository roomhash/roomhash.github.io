...
const catalog = {
  ...
  'roomlet.open': ['Open Roomlets', '打开聊应用'],
  'roomlet.title': ['Roomlet', '聊应用'],
  'roomlet.close': ['Close Roomlets', '关闭聊应用'],
  'roomlet.help': ['Roomlets only show data synchronized from connected peers; completeness and consistency are not guaranteed.', '聊应用仅展示关联节点同步过来的数据，并不保证显示数据的完整性和一致性。'],
  'roomlet.loading': ['Loading Roomlets...', '正在加载聊应用…'],
  'roomlet.empty': ['No Roomlets are available.', '暂无可用的聊应用。'],
  'roomlet.unavailable': ['Roomlets are unavailable: {message}', '聊应用暂不可用：{message}'],
  'roomlet.send': ['Send', '发送'],
  'roomlet.sending': ['Sending...', '发送中…'],
  'roomlet.wasm': ['Roomlet', '聊应用'],
  'roomlet.web': ['Web app', '网页应用'],
  'roomlet.sent': ['Roomlet shared with this channel', '聊应用已分享到当前频道'],
  'demo.label': ['RoomHash demos', 'RoomHash 演示'],
  'demo.title': ['Try RoomHash together', '一起试试 RoomHash'],
  'demo.description': ['Share a streamable video or invite the room into a shared garden.', '分享可流式播放的视频，或邀请频道成员一起种下共享花园。'],
  ...
  'wasm.type': ['RoomHash Roomlet', 'RoomHash 聊应用'],
  ...
  'wasm.permissionIsolation': ['The app cannot directly access the DOM, local files, camera, microphone, or arbitrary network connections. Approved capabilities are brokered by RoomHash.', '应用无法直接访问 DOM、本地文件、摄像头、麦克风或任意网络连接；获准的能力均由 RoomHash 受控代理。'],
  ...
  'cabinet.send': ['Send to current channel', '发送到当前频道'],
  'cabinet.sent': ['Sent to current channel', '已发送到当前频道'],
